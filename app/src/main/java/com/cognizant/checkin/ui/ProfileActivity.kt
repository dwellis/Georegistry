...
import com.cognizant.checkin.databinding.ActivityProfileBinding
        ...
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(admin.toBoolean()) {
                    ...
                    binding.profileButtonOption.text = getString(R.string.profile_button_manage_text)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if(admin.toBoolean()) {
            return when (item.itemId) {
                R.id.main_menu_home -> {
                    val homeIntent = Intent(this, RegistrarLanding::class.java)
            ...
            return when (item.itemId) {
                R.id.main_menu_home -> {
                    val homeIntent = Intent(this, UserLanding::class.java)
                    startActivity(homeIntent)
                    true
                }
                R.id.main_menu_profile -> {
